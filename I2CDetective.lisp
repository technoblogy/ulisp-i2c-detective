...
(defvar *devices*
  '(("6-Axis IMU" ("LSM6DSOX" #x6A #x6B) ("LSM6DS33" #x6A #x6B) ("ICM330DHC" #x6A #x6B))
    ("9-Axis IMU" ("MPU-9250" #x68 #x69) ("LSM9DS0" #x1D #x6B (any #x1D #x1E #x6A #x6B)) ("BNO055" #x28 #x29))
    ("Accelerometer" ("BMA180" #x77 #x77) ("LIS3DH" #x18 #x19 (whoami #x0F #x33)) 
     ("MMA845x" #x1C #x1D) ("MMA7455L" #x1C #x1D) ("ADXL345" #x1D #x53 (any #x1D #x53)) ("MSA301" #x26 #x26))
    ...
    ("FM Transmitter" ("Si4713" #x11 #x63 (any #x11 #x63)))
    ...
    ("Light Sensor" ("Si1145" #x60 #x60) ("VEML7700" #x10 #x10) ("TSL2591" #x28 #x29) ("TSL2561" #x29 #x49 (any #x29 #x39 #x49)) 
     ("BH1750" #x23 #x5C (any #x23 #x5C)))
    ("Magnetometer" ("TLV493D" #x5E #x5E) ("MAG3110" #x0E #x0E) ("LIS3MDL" #x1C #x1E (any #x1C #x1E)) ("HMC5883" #x1E #x1E) 
     ("LIS2MDL" #x1E #x1E))
    ("Motor Driver" ("DRV2605" #x5A #x5A))
    ("Multiplexer" ("TCA9548" #x70 #x77))
    ("NFC/RFID Reader" ("PN532" #x48 #x48))
    ("Nunchuck Controller" ("Nintendo" #x52 #x52))
    ("OLED Display" ("SSD1305" #x3D #x3D) ("SSD1306" #x3D #x3D))
    ...
    ("PWM Driver" ("PCA9685" #x40 #x7F (any #x40 #x7F)))
    ("Radio Receiver" ("TEA5767" #x60 #x60))
    ("Real-Time Clock" ("DS1307" #x68 #x68) ("DS3231" #x68 #x68) ("PCF8523" #x68 #x68))
    ("Resistive Touch Controller" ("STMPE610" #x41 #x44 (any #x41 #x44)) ("STMPE811" #x41 #x44 (any #x41 #x44)))
    ("Temperature Sensor" ("TMP117" #x48 #x49) ("TMP102" #x48 #x4B) ("MCP9808" #x18 #x1F (whoami #x07 #x04)))
    ("Temperature/Pressure Sensor" ("BMP085" #x77 #x77) ("BMP280" #x76 #x77) ("BMP180" #x77 #x77))
    ("Temperature/Pressure/Humidity Sensor" ("BME280" #x76 #x77))
    ("Temperature/Pressure/Humidity/Gas Sensor" ("BME680" #x76 #x77))
      ...
      (dolist (device options)
        (let* ((id (first device))
          ...
          (when
              (and
               (<= from p to)
               (or (null test) (funcall (eval test) p)))
            (format t "#x~x: ~a - ~a~%" p name id)))))))

(defun any (&rest lst)
  (lambda (p) (member p lst)))
